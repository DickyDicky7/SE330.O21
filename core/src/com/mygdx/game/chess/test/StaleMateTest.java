...
public final class StaleMateTest {
    ...
    public void testAnandKramnikStaleMate() {
        ...
        assertTrue(t1.latestBoard().currentPlayer().isInStalemate());
        assertFalse(t1.latestBoard().currentPlayer().isInCheck());
        assertFalse(t1.latestBoard().currentPlayer().isInCheckmate());
    }
