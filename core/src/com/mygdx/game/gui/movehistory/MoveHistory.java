...
public final class MoveHistory extends Table {
    ...
    private final TakenPiece whiteTakenPiece;
    private final TakenPiece blackTakenPiece;
    ...
    private enum TakenPieceDirection {
        ...
        private void updateMoveHistory(final MoveHistory moveHistory) {
            ...
            int i = 0, j = 1;
            for (final Move move : moveHistory.moveLogger.getMoves()) {
            ...
            moveHistory.whiteTakenPiece.updateTakenPiece(moveHistory.moveLogger);
            moveHistory.blackTakenPiece.updateTakenPiece(moveHistory.moveLogger);
        }
    }
    ...
    private static final class TakenPiece extends Table {
        ...
        private void updateTakenPiece(final MoveLogger moveLogger) {

            final HashMap<Piece, Integer> takenPieces = new HashMap<>();

            for (final Move move : moveLogger.getMoves()) {
                if (move.isAttack()) {
        ...
        private void addTakenPiece(final HashMap<Piece, Integer> takenPiecesMap) {
            ...
            for (final Piece takenPiece : takenPieces) {
                this.add(new Image(GuiUtils.GetPieceTextureRegion(takenPiece))).size(40, 40);
