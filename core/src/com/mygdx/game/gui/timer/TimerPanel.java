...
public final class TimerPanel extends Table {
    ...
    private final PlayerTimerTable whitePlayerTimerTable;
    private final PlayerTimerTable blackPlayerTimerTable;
    ...
    private static final class PlayerTimerTable extends Table {
        ...
        private PlayerTimerTable(final Color panelColor, final Color labelColor, final CharSequence text) {
            ...
            this.add(timerLabel);
            this.setVisible(true);
            this.setBackground(new NinePatchDrawable(new NinePatch(GuiUtils.GetTiledTextureRegion("white"), panelColor)));
        }
